...
criamos um \texttt{Map} chamado "users_rep". Este Map possui como
...
no map "users_rep" um user com a chave (Id) do utilizador que fez a pergunta),
...
Assim, adicionamos os IDs dessas tags a um \texttt{ArrayList} chamado ident_tags.
...
temos um ArrayList "ident_tags", com todos os identificadores das tags
...
identificadores das tags (presentes no ArrayList "ident_tags") corresponderá o
